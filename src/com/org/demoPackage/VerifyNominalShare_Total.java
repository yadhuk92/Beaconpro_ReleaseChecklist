...
public class VerifyNominalShare_Total {
	
public static void VerifyFinalTotal(WebDriver driver, String propertyValue) throws IOException {
		...
		String Total_org= String.format("%.2f",Total);
		System.out.println(" total after to string conversion "+Total_org );
		
		//if(ActualValue.substring(0, 5).equals(Total_org)) {
		if(String.format("%.2f",Float.parseFloat(ActualValue)).equals(Total_org)) {
